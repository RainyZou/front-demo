...
var UplinkService = /** @class */ (function (_super) {
    __extends(UplinkService, _super);
    function UplinkService(paramHttp, authGuard) {
    ...
    //分页
    UplinkService.prototype.page = function (_successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.UPLINK_PAGE_URL;
    ...
    UplinkService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, auth_guard_1.AuthGuard])
    ], UplinkService);
    return UplinkService;
}(base_service_1.BaseService));
exports.UplinkService = UplinkService;
//# sourceMappingURL=uplink.service.js.map