...
var ParaService = /** @class */ (function (_super) {
    __extends(ParaService, _super);
    function ParaService(paramHttp, authGuard) {
    ...
    //新增
    ParaService.prototype.create = function (_commandId, _paraName, _dataType, _required, _min, _max, _step, _maxLength, _unit, _enumList, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.PARA_CREATE_URL;
        var _data = {
    ...
    //分页
    ParaService.prototype.page = function (commandId, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.PARA_PAGE_URL;
    ...
    ParaService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [http_1.Http, auth_guard_1.AuthGuard])
    ], ParaService);
    return ParaService;
}(base_service_1.BaseService));
exports.ParaService = ParaService;
//# sourceMappingURL=para.service.js.map