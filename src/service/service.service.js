...
var ServiceService = /** @class */ (function (_super) {
    ...
    function ServiceService(paramHttp, authGuard) {
    ...
    //新增
    ServiceService.prototype.create = function (_productId, _serviceType, _description, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.SERVICE_CREATE_URL;
        var _data = {
    ...
    //分页
    ServiceService.prototype.page = function (productId, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.SERVICE_PAGE_URL;
