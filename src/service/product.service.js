...
var ProductService = /** @class */ (function (_super) {
    ...
    function ProductService(paramHttp, authGuard) {
    ...
    //新增
    ProductService.prototype.create = function (_manufacturerId, _manufacturerName, _model, _protocolType, _productType, _description, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.PRODUCT_CREATE_URL;
        var _data = {
    ...
    //分页
    ProductService.prototype.page = function (_successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.PRODUCT_PAGE_URL;
