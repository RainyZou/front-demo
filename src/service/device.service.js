...
var DeviceService = /** @class */ (function (_super) {
    ...
    function DeviceService(paramHttp, authGuard) {
    ...
    //新增
    DeviceService.prototype.init = function (_productId, _devName, _devEui, _providerType, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.DEVICE_INIT_URL;
        var _data = {
    ...
    //分页
    DeviceService.prototype.page = function (_successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.DEVICE_PAGE_URL;
    ...
    //设备拥有的服务命令列表
    DeviceService.prototype.downMeta = function (deviceId, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.DEVICE_DOWNMETA_URL;
