...
var ModelDataService = /** @class */ (function (_super) {
    __extends(ModelDataService, _super);
    function ModelDataService(paramHttp, authGuard) {
    ...
    //分页
    ModelDataService.prototype.refresh = function (productId, _successCallback, _errorCallback) {
        if (_errorCallback === void 0) { _errorCallback = null; }
        var _reqUrl = global_context_1.MODELDATA_REFRESH_URL;
...
//# sourceMappingURL=model-data.service.js.map